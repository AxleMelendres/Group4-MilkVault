...
// Prepare daily sales data (default 30 days)
$range = intval($_GET['range'] ?? 30);
$dailySalesData = getDailySalesData($conn, $range);
?>
...
<div class="d-flex">
    <nav class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link" href="#" data-section="sales-report"><i class="fas fa-chart-line"></i> Sales Report</a></li>
        </ul>
    </nav>
                                        ...
                                        <div class="modal fade" id="qrModal<?= $order['order_id'] ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content text-center p-4">
                                                    ...
                                                    $qrData = $base_url . 'updateOrderStatus.php?order_id=' . urlencode($order['order_id']);
                                                    ?>
...
<section id="sales-report" class="section" style="display:none;">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>Daily Sales Report</h5>
            <select id="salesRange" class="form-select w-auto">
...
<script>
    window.dailySalesData = <?= json_encode($dailySalesData); ?>;
</script>
